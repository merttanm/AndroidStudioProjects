...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
       ...
       /* galleryViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
        ...
        img= (ImageView) root.findViewById(R.id.dfdf);
        img2= (ImageView) root.findViewById(R.id.dfdf);
        img3= (ImageView) root.findViewById(R.id.dfdf);
        img4= (ImageView) root.findViewById(R.id.dfdf);
     /*   resimyükle(url);
        resimyükle2(url_2);
        resimyükle3(url_3);
        resimyükle4(url_4);*/

        String[] images ={url,url_2,url_3,url_4};
